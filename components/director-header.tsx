...
export function DirectorHeader({ userEmail }: { userEmail: string }) {
  ...
  const currentSection = (() => {
    if (pathname === "/director") return "Review Dashboard";
    if (pathname === "/director/approved") return "Approved Proposals";
        ...
        <div className="container mx-auto flex items-center justify-between gap-4 px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            <div className="hidden lg:flex items-center gap-2">
              <Link href="/director" onClick={() => setMenuOpen(false)}>
                <Button
                  variant={
                    isActive(pathname, "/director") ? "default" : "outline"
                  }
