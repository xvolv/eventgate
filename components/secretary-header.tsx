...
export function SecretaryHeader({ userEmail }: { userEmail: string }) {
  ...
  const currentSection = (() => {
    if (pathname === "/secretary") return "Review Dashboard";
    if (pathname === "/secretary/approved") return "History";
        ...
        <div className="container mx-auto flex items-center justify-between gap-4 px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            <div className="hidden lg:flex items-center gap-2">
              <Link href="/secretary" onClick={() => setMenuOpen(false)}>
                <Button
                  variant={
                    isActive(pathname, "/secretary") ? "default" : "outline"
                  }
